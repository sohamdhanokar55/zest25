...
interface RegistrationFormFieldsProps {
  ...
  // Player Fields (additional players only; Player 1 = Team Leader)

  numberOfPlayers: number; // total players incl. leader
  ...
  players: PlayerField[]; // additional players (Player 2 onwards)
  ...
  teamLeaderNameError?: string | null;

  teamLeaderContactError?: string | null;

  alternateContactError?: string | null;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 ${
                teamLeaderNameError ? "border-red-500" : "border-gray-300"
              }`}
              placeholder="Enter team leader name"
            />

            {teamLeaderNameError && (
              <p className="mt-1 text-xs text-red-600">{teamLeaderNameError}</p>
            )}
          </div>
          ...
          <div>
            ...
            <input
              ...
              required
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 ${
                teamLeaderContactError ? "border-red-500" : "border-gray-300"
              }`}
          ...
          <div>
            ...
            <input
              ...
              required
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 ${
                alternateContactError ? "border-red-500" : "border-gray-300"
              }`}
